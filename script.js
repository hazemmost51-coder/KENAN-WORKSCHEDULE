...
const descriptionList = ["حفر وتمديد","طوارئ","صيانة","هيكلة محول هوائي","شد شبكة هوائية","رفع رايزر",,"انزال رايزر","صيانة عدادات",
      "نهايات ضغط منخفض", "نهايات ضفط متوسط","وصلة لحام ضغط منخفض", "وصلحة لحام ضفط متوسط", "تركيب عدادات", "تركيب محول ارضي",
     "تركيب وحدة حلقية", "تركيب لوحة توزيع فرعية", "خرسانة"," اسفلت"];
