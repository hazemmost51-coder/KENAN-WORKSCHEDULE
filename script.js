...
const dataStore = {
    "فرق الحفر والتمديد": ["عمر الطيب", "اشرف", "كرم", "ممدوح", "علاء مرسي", "جامشيد", "جمال", "سيد زين", "محمود صلاح", "كنان"],
    "فرق الترمنيشن": ["يحي","سمير", "عمرو رزق", "رحمات غول","راجا", "اماندو", "بارديب", "جلين", "جيريكو", "كليان", "محمد احمد", "مانيكندن", "سوريش", "جونس"],
    "فرق الهوائي": ["بالا", "سيلفم", "هارفول", "خير الزمان", "افتخار", "الجون", "ارفينال", "جميل", "جينارد"],
    "الجي سي بيهات": ["سكندر CAT", "ارفيند CASE", "ميراج CASE", "بالا CASE", "منتاج CASE", "افضل BOB", "رقيب BOB", "زاهد CASE", "يوداف CASE", "فاروق BOB", "نعيم BOB","كلويندر BOB"],
    "الكرينات": ["معصوم", "سونيل", "غلام كرين", "محمد علي", "قمر الدين"],
    "البوبكتات": ["عاشق", "نصر الله", "ديل سعد", "اميرول", "فينود"],
    "القلابات والسطحات": ["رافي", "سيد", "شاهين"]
};

const siteList = ["ابو عريش", "ضمد", "جيزان", "صامطة", "صبيا", "مستودع الشركة", "الورشة","بيش","فرسان"];
const consultantList = ["سعودي كونسلت", "حسن فقية", "علوم العمران", "محرم باخوم", "الميناء", "بدون"];
const typeList = ["فصل", "تشغيلي", "انشائي"];
const descriptionList = ["حفر وتمديد","حفر وتمديد مواسير فايبر","طوارئ","صيانة","صيانة تحسينية","هيكلة محول هوائي","شد شبكة هوائية","رفع رايزر","انزال رايزر","صيانة عدادات",
      "نهايات ضغط منخفض", "نهايات ضفط متوسط","وصلة لحام ضغط منخفض", "وصلحة لحام ضفط متوسط", "تركيب عدادات", "تركيب محول ارضي",
     "تركيب وحدة حلقية", "تركيب لوحة توزيع فرعية", "خرسانة"," اسفلت"," كشط اسفلت"];
const engineers = ["عمرو", "أحمد", "حازم", "صقر", "محمد", "علاء", "ابراهيم","كليم الله"];

const contactLeads = {
    "عمرو": "0506103042", "أحمد": "0535551691", "حازم": "0550884353", "صقر": "0570072790","كليم الله":"0550293386",
    ...
    "سيلفم": "0570327804", "هارفول": "0572551870", "خير الزمان": "0554509165", "افتخار": "0552581182",
    "الجون": "0501358095", "ارفينال": "0581327592", "جميل": "555877538", "جينارد": "0564479067",
    "يحي": "0547044215", "عمرو رزق": "0547044215", "سمير": "0578713378", "رحمات غول": "0530018133", "محمود صلاح": "0576291736"
};

const assetCodes = {
    "عمر الطيب": "KU1", "اشرف": "KU2", "كرم": "KU3", "ممدوح": "KU4", "علاء مرسي": "KU5",
    "جامشيد": "KU6", "جمال": "KU7", "كنان": "KU8", "سيد زين": "KU9", "محمود صلاح": "KU10", "راجا": "KS1",
